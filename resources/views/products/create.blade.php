...
<div class="p-6 bg-white border-b border-gray-200">
    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-span-3">
            ...
            <div class="mt-2">
              <input type="text" name="slug" id="slug" value="{{ old('slug') }}" autocomplete="slug" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            </div>
            @error('slug')
                <span class="text-red-500">{{ $message }}</span>
            @enderror
